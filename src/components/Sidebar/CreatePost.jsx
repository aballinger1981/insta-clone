...
import { arrayUnion, collection, addDoc, doc, updateDoc } from "firebase/firestore";
  ...
  const handleCreatePost = async (selectedFile, caption) => {
    ...
    try {
      ...
      if (userProfile.uid === authUser.uid) {
        createPost({ ...newPost, id: postDocumentRef.id });
      }
      if (pathname !== "/" && userProfile.uid === authUser.uid) {
        addPost({ ...newPost, id: postDocumentRef.id });
      }
